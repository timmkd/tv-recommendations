...
function dbShowToOverlay(row: DbShow): ShowOverlay {
  return {
    ...
    bingeability: row.bingeability ?? undefined,
    ...
    predictedBingeability: row.predictedBingeability ?? undefined,
    predictedBingeabilityReason: row.predictedBingeabilityReason ?? undefined,
...
function overlayToDbShow(overlay: ShowOverlay): Omit<typeof shows.$inferInsert, 'id' | 'createdAt' | 'updatedAt'> {
  return {
    ...
    bingeability: overlay.bingeability ?? null,
    ...
    predictedBingeability: overlay.predictedBingeability ?? null,
    predictedBingeabilityReason: overlay.predictedBingeabilityReason ?? null,
